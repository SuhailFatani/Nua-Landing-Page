...
echo "   npm run dev"
echo ""
echo "📡 API will be available at: http://https://nua-landing-page-production.up.railway.app"
echo "🔍 Health check: http://https://nua-landing-page-production.up.railway.app/health"
echo ""
echo "📋 API Endpoints:"
